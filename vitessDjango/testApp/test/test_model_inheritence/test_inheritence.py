...
class TestModelInheritance(TestCase):
    ...
    def test_multi_table_inheritance_parent_child_one_to_one_link(self):
        ...
        self.assertEqual(
            Place.objects.get(name="McLarens").restaurant.italianrestaurant,
            ItalianRestaurant.objects.get(name="McLarens"),
        )
        self.assertEqual(
            Restaurant.objects.get(name="McLarens").italianrestaurant,
            ItalianRestaurant.objects.get(name="McLarens"),
        )
